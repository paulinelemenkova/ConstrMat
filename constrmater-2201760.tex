...
\Author{\hl{Per Lindh} %MDPI: Please carefully check the accuracy of names and affiliations.
 $^{1,2,}$\hl{*} %MDPI: The Correspondence author is different from our system. Please check which one is correct.
\orcidA{} and Polina Lemenkova $^{3,}$\hl{*} %MDPI: We add this symbol here to keep the consistent with correspondence email and our system. Please confirm.
\orcidB{}}
...
\address{%
$^{1}$ \quad Department of Investments, Technology and Environment, Swedish Transport Administration, Neptunigatan~52, Box 366, \hl{201 23} %MDPI: The postcode of the same Country should be keep the consistent format. Please revise the affs 1 and 2.
 Malmö, Sweden \\
$^{2}$ \quad Division of Building Materials, Department of Building and Environmental Technology, Lunds Tekniska Högskola LTH (Faculty of Engineering), Lund University, Box 118, \hl{SE-221-00} Lund, Sweden \\
$^{3}$ \quad Laboratory of Image Synthesis and Analysis (LISA), École Polytechnique de Bruxelles (Brussels Faculty of Engineering), Université Libre de Bruxelles (ULB)\hl{,} %MDPI: We replace dot ro comma. Please confirm.
 Building L, Campus du Solbosch, ULB--LISA CP165/57, Avenue Franklin D. Roosevelt 50, 1050 Brussels, Belgium
}

% Contact information of the corresponding author
\corres{Correspondence: \hl{per.lindh@trafikverket.se} %MDPI: Please confirm if this email should be retained.
...
% Keywords
\keyword{\highlight{s}oil strength; binders; road pavements; soil strength; recycling technologies; materials science; engineering; civil engineering; construction; compressive strength; soil stabilization}
%MDPI: We changed the first letter of all words to lowercase. Please check and confirm.
...
\MSC{\highlight{76Axx}; \highlight{74Exx}; \highlight{74Fxx}}%MDPI: Please check if these MSC code is correct.
...
\end{equation}
where $\beta$ is the coefficient of regression; $\epsilon$ is the residual error; $x_1$ is the value of binders which indicate factors; \hl{y} %MDPI: Equation elements should be kept the consistent format with equation. Please check and revise. The same below.
...
\caption{\hl{Temperature} %MDPI: Please change the hyphen (-) into a minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1".
...
\end{adjustwidth}
\caption{\textbf{Left}: Pareto diagram of all the effects included in the cubic model for estimated gain in strength of soil on day 14. \textbf{Right}: Pareto diagram of the significant effects from binders on stabilized soil included in the cubic model for the measurements on \hl{day~14.} %MDPI: Please change the hyphen (-) into a minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1".
 \label{fig4}}
\end{figure} 
...
\begin{figure}[H]
%\centering
	\hspace{-18pt}\includegraphics[width=14.0 cm]{Fig_05}
\caption{The P-wave velocity on day 14 during soil stabilization. \textbf{Left}: increased interaction between lime and slag. \textbf{Right}: larger interaction between cement \hl{and~slag.} %MDPI: Please add 0 before decimal dot, e.g., .8728 should be 0.8728.
 \label{fig5}}
\end{figure} 
...
\begin{figure}[H]
%\centering
	\hspace{-18pt}\includegraphics[width=14.0 cm]{Fig_06}
\caption{The response of the soil strength after compression indicated by the P-wave velocity measured on day 14 upon stabilization. \textbf{Left}: interaction between cement, lime and slag. \textbf{Right}: large interaction between energy fly \hl{ash and~slag.} %MDPI: Please add 0 before decimal dot, e.g., .8728 should be 0.8728.
 \label{fig6}}
\end{figure} 
...
\begin{figure}[H]
%\centering
	\hspace{-18pt}\includegraphics[width=14.0 cm]{Fig_07}
\caption{The response of the soil strength after compression indicated by the P-wave velocity measured on day 14 upon stabilization. \textbf{Left}: increased interactions between cement and fly ash. \textbf{Right}: increased interaction effects between fly ash \hl{and~lime.} %MDPI: Please add 0 before decimal dot, e.g., .8728 should be 0.8728.
 \label{fig7}}
\end{figure} 

As the bio fly ash from the SCA Lilla Edet shows poorer results. This may be due to the carbonation of the binder, i.e.,~the presence of lime in ash has reacted with the \hl{$CO_2$} %MDPI: Please confirm if the italics is unnecessary and can be removed. The following highlights are the same.
 in the air and inert \hl{$CaCO_3$} (cf. limestone) has been formed. Previous studies arrived with a better effect from the mixture of lime and fly ash in connection with the stabilization of clayey soil~\cite{ANDAVAN20201125,TOKSOZHOZATLIOGLU2021105931,KHADKA2020100327}. There is no clear answer to the question why the energy fly ash only functions as an inert filler. One reason could be that there is a threshold value of the water binder number. If~ash is to be used in larger projects, the~availability of the 'fresh' ash (i.e., recently made product) should be ensured to minimize possible variations in the stabilized road~base.
...
\funding{The publication was funded by the Editorial Office of the \emph{\hl{Construction~Materials} %MDPI: Please confirm if the italics is unnecessary and can be removed. 
...
\acknowledgments{The authors thank the anonymous reviewers for reading, suggestions and comments that improved an earlier version of this manuscript. \hl{This research was supported by the SBUF (Development Fund of the Swedish Construction Industry), Nordkalk AB, SSAB Merox AB and Svenska Cellulosa AB (SCA) Lilla Edet Pappersbruk.} %MDPI: We suggest  that this sentence should be moved to Funding section. Please revise.
}
...
\newblock {\em Expansive Soils: Problems and Practice in Foundation and
  Pavement Engineering}; John Wiley \& Sons Inc.: \hl{Hoboken, NJ, USA,} %We added the location of publisher. Please confirm
 1992.
...
Montgomery, D.C.
\newblock {\em Design and Analysis of Experiments}; Wiley \& Sons, Inc.:  \hl{Hoboken, NJ, USA,} %We added the location of publisher. Please confirm
  1997.

\bibitem[Box \em{et~al.}(2005)Box, Hunter, and Hunter]{Box}
Box, G.E.P.; Hunter, W.G.; Hunter, J.S.
\newblock {\em Statistics for Experimenters}, 2nd ed.; Wiley-Interscience: \hl{New York, NY, USA, } %MDPI: We added the location of publisher. Please confirm.
 2005.
\newblock 655p.
...
\newblock {Quality Control of Cement stabilized Soil Using Non-destructive
  Seismic Tests}.
\newblock \emph{\hl{Adv. Test. Fresh Cem. Mater. Lect.}} \textbf{2006}, \emph{34}, \hl{3--4.} %MDPI: \hl{} %MDPI: Newly added information. Please confirm.
...
\newblock {\em Response Surface Methodology. Process and Product Optimization
  Using Designed Experiments}; John Wiley \& Sons, Inc.: \hl{Hoboken, NJ, USA,} %We added the location of publisher. Please confirm
   1995.
...
\newblock \hl{International Conference on Materials Engineering and
  Characterization 2019.} %MDPI: Please confirm if it is unnecessary and can be removed. The following highlights are the same.
...
Sherwood, P.
\newblock {\em Soil Stabilization with Cement and Lime}; TRL, HMSO: \hl{Richmond, UK,} %MDPI: Newly added information. Please confirm.
 1993.
