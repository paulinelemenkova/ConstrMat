...
\corres{Correspondence: %MDPI: Please confirm if this email should be retained. <-- Authors' reply: no, this email is deleted.
 per.lindh@byggtek.lth.se (P.L.); polina.lemenkova@ulb.be (P.L.); Tel.: +46-0771-921-921 (P.L.); +32-471-86-04-59 (P.L.)}
...
\caption{Experimental design scheme. \textbf{(a)}: 3$\times$2 factor experiment for evaluation of the effects of binders on soil strength. \textbf{(b)}: Schematic image of a ``mixture design'' with three factors; A, B and C. The~experimental setup is called simplex-lattice (3$\times$2). \label{fig1}}
\end{figure}  
...
%\centering %% If there is a figure in wide page, please release command \centering
	\hspace{99pt}\includegraphics[width=14 cm]{Fig_04}
\end{adjustwidth}
\caption{\textbf{(a)}: Pareto diagram of all the effects included in the cubic model for estimated gain in strength of soil on day 14. \textbf{(b)}: Pareto diagram of the significant effects from binders on stabilized soil included in the cubic model for the measurements on day 14. %MDPI: Please change the hyphen (-) into a minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1". <-- Authors' reply: Figure 4 is corrected and replotted with hyphen changed to minus sign.
 \label{fig4}}
\end{figure} 
...
\caption{The P-wave velocity on day 14 during soil stabilization. \textbf{(a)}: increased interaction between lime and slag. \textbf{(b)}: larger interaction between cement and slag. %MDPI: Please add 0 before decimal dot, e.g., .8728 should be 0.8728. <-- Authors' reply: ok, Figure 5 is corrected and replotted.
 \label{fig5}}
\end{figure} 
...
\caption{The response of the soil strength after compression indicated by the P-wave velocity measured on day 14 upon stabilization. \textbf{(a)}: interaction between cement, lime and slag. \textbf{(b)}: large interaction between energy fly ash and~slag. %MDPI: Please add 0 before decimal dot, e.g., .8728 should be 0.8728. <-- Authors' reply: ok, Figure 6 is corrected and replotted.
 \label{fig6}}
\end{figure} 
...
\caption{The response of the soil strength after compression indicated by the P-wave velocity measured on day 14 upon stabilization. \textbf{(a)}: increased interactions between cement and fly ash. \textbf{(b)}: increased interaction effects between fly ash and~lime. %MDPI: Please add 0 before decimal dot, e.g., .8728 should be 0.8728. <-- Authors' reply: ok, Figure 7 is corrected and replotted.
 \label{fig7}}
\end{figure} 
...
\funding{This research was supported by the SBUF (Development Fund of the Swedish Construction Industry), Nordkalk AB, SSAB Merox AB and Svenska Cellulosa AB (SCA) Lilla Edet Pappersbruk.} %MDPI: Please confirm if the italics is unnecessary and can be removed. <-- Authors' reply: ok, not necessary and removed. The MDPI office is removed from the funding part, according to suggestion
...
\newblock {Quality Control of Cement stabilized Soil Using Non-destructive
  Seismic Tests}.
\newblock \emph{Adv. Test. Fresh Cem. Mater. Lect.} \textbf{2006}, \emph{34}, 3--4. %MDPI: Newly added information. Please confirm. <-- Authors' reply: yes, we agree and confirm.
