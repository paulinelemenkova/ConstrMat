...
\hl{We have tested our method of soil stabilization by using several various binders in diverse combination and proportions. In this section, we show images depicting the obtained results on strength of the stabilized soil measured by P-wave velocities and visualised as ternary diagrams.} Upon the processing \hl{of the soil samples} and stabilising\hl{ }the specimens, the obtained values \hl{in strength }were \hl{evaluated} statistically\hl{ and }visualized as Pareto charts \hl{in} Figure \ref{fig4}\hl{.}
